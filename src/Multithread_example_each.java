...
// Main Class
public class Multithread_example_each {
    public static void main(String[] args)
    {
        ...
        FileQueueJNI fq_obj1 = new FileQueueJNI( 0, "/tmp/jni_TestDeQ.log", 4, qpath, qname);
		FileQueueJNI fq_obj2 = new FileQueueJNI( 1, "/tmp/jni_thread.log", 4, qpath, qname);
        FileQueueJNI fq_obj3 = new FileQueueJNI( 2, "/tmp/jni_TestDeQ.log", 4, qpath, qname);
		FileQueueJNI fq_obj4 = new FileQueueJNI( 3, "/tmp/jni_thread.log", 4, qpath, qname);
        ...
        rc = fq_obj3.open();
        if( rc < 0 ) {
            System.out.println("open failed: " + fq_obj3.logname + "," + fq_obj3.path + "," + fq_obj3.qname + "," + " rc: " + rc);
            return;
        }
        System.out.println("open success: " + fq_obj3.logname + "," + fq_obj3.path + "," + fq_obj3.qname + "," + " rc: " + rc);

        rc = fq_obj4.open();
        if( rc < 0 ) {
            System.out.println("open failed: " + fq_obj4.logname + "," + fq_obj4.path + "," + fq_obj4.qname + "," + " rc: " + rc);
            return;
        }
        System.out.println("open success: " + fq_obj4.logname + "," + fq_obj4.path + "," + fq_obj4.qname + "," + " rc: " + rc);
        ...
        de_object1.start();
        MultithreadingDemo_deQ de_object2 = new MultithreadingDemo_deQ( fq_obj2 );
        de_object2.start();

        MultithreadingDemo_enQ en_object3 = new MultithreadingDemo_enQ( fq_obj3 );
        en_object3.start();
        MultithreadingDemo_enQ en_object4 = new MultithreadingDemo_enQ( fq_obj4 );
        en_object4.start();
    }
}
